<script lang="ts">
	...
	export let isVoicebotEnabled: boolean = false;
...
<div class="speech-bubble-container">
	<div 
		class="speech-bubble"
		class:active={isVoicebotEnabled}
...
<style>
	...
	.speech-bubble {
		...
		filter: drop-shadow(0 0 30px rgba(139, 92, 246, var(--glow-intensity, 0.15)))
				drop-shadow(0 0 50px rgba(79, 70, 229, calc(var(--glow-intensity, 0.15) * 0.7)));
