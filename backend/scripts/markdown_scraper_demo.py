#!/usr/bin/env python3
"""
Demonstration script for the markdown scraper functionality.
This script shows how to scrape markdown files and store text sections in the vector database.
"""
...
def main():
    ...
    try:
        ...
        for i, section in enumerate(preview_sections, 1):
            content_preview = section.get_clean_content()[:200] + "..." if len(section.get_clean_content()) > 200 else section.get_clean_content()
